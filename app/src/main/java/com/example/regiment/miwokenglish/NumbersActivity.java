...
public class NumbersActivity extends AppCompatActivity {
    ...
    // we made global object for completion of audio file so that at every time we don't have to create a new
    // instance whenever we wish to play an another sound, that will coast us resources and less efficient.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomArrayAdapter itemsAdapter = new CustomArrayAdapter(this, words, R.color.category_number);
        ...
        // making an onItemClick event listener for list items.
